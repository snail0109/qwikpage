...
export function arrayToTree(array: any, parentId = null) {
  ...
  return Object.values(map)
    ...
    .sort((a: any, b: any) => a.sortNum - b.sortNum);
}
 ...
 * @returns
 */
export function getPageId(pageId: string | undefined, pageMap: Record<string, any>): string {
 ...
 * @returns
 */
export function newArrayToTree(array: IMenuItem[] = []) {
