              ...
              menu={{
                ...
                onClick: ({ key }) => {
                  if (key === "required") {
                    ...
                    add(
                      { key: "word", pattern: "^[a-zA-Z]+$", message: "只能输入英文单词" },
                      fields.length
                    );
                  } else if (key === "number") {
                    add(
                      { key: "number", pattern: "^[0-9]+$", message: "只能输入数字" },
                      fields.length
                    );
                  } else if (key === "chinese") {
                    add(
                      { key: "chinese", pattern: "^[\u4e00-\u9fa5]+$", message: "只能输入中文" },
                      fields.length
                    );
                    ...
                    add(
                      { key: "numberMoney", pattern: "^(0|[1-9]\\d+)$", message: "请输入正整数" },
                      fields.length
                    );
